 ...
 */
final class Version20250212155946 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT NOT NULL, societe TEXT DEFAULT NULL, autre INT DEFAULT NULL, PRIMARY KEY(id))');
